      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="bg-white rounded-md p-5 sm:p-6 border border-[#E2DDD3] space-y-4">
              {/* Google Rating Block */}
              <div className="flex items-center justify-between pb-4 border-b border-[#F0EBE1]">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <div className="font-extrabold text-base text-[#1C1917]">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-1 text-xs font-semibold text-[#B83220] hover:underline"
                >
            ...
            <div className="flex flex-row gap-2.5">
              <a
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 py-3 px-4 rounded-md font-semibold text-xs sm:text-sm text-white bg-[#B83220] hover:bg-[#9E2818] active:bg-[#852012] transition-colors shadow-xs min-h-[44px] whitespace-nowrap"
              >
              ...
              <a
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 py-3 px-4 rounded-md font-semibold text-xs sm:text-sm text-[#1C1917] bg-[#EFECE6] hover:bg-[#E2DDD3] active:bg-[#D5CFBF] border border-[#DCD6C9] transition-colors min-h-[44px] whitespace-nowrap"
              >
          ...
          <div className="lg:col-span-7">
            <div className="bg-white rounded-md border border-[#E2DDD3] overflow-hidden">
              ...
              <div className="relative w-full h-[240px] sm:h-[300px] lg:h-[340px] bg-[#EAE5DB]">
                <iframe
              ...
              <div className="p-2.5 bg-[#FAF8F5] border-t border-[#EAE5DB] text-[11px] text-[#78716C] flex items-center justify-between">
                <span>Jl. Canadian Broadway Kota Wisata No.15 Blok E</span>
                <span className="text-[#1C1917] font-medium">Cileungsi, Bogor</span>
              </div>
            </div>
          </div>
        </div>
