...
export default function Hero() {
  return (
    <section
      ...
      className="relative pt-20 pb-8 sm:pt-28 sm:pb-12 lg:pt-32 lg:pb-14 bg-[#FAF8F5]"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-4 sm:space-y-5">
            ...
            <div className="space-y-2.5">
              <h1
                id="hero-headline"
                className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#1C1917] tracking-tight leading-[1.15]"
              >
                Makan enak,{' '}
            ...
            <div className="flex flex-wrap items-center gap-3 pt-0.5">
              <a
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-md bg-[#F2EFE9] hover:bg-[#E8E4DC] transition-colors border border-[#E0DACF] text-xs sm:text-sm"
              >
                <Star className="w-3.5 h-3.5 fill-amber-500 text-amber-500" />
                <span className="font-bold text-[#1C1917]">{RESTAURANT_INFO.googleRating}</span>
              ...
              <div className="inline-flex items-center gap-1.5 text-xs sm:text-sm text-[#78716C] px-1 py-1">
            ...
            {/* CTAs */}
            <div className="flex flex-row items-center gap-3 pt-1.5">
              <a
                href="#menu"
                id="hero-primary-cta"
                className="inline-flex items-center justify-center gap-2 px-6 py-3 text-sm sm:text-base font-semibold text-white bg-[#B83220] hover:bg-[#9E2818] active:bg-[#852012] transition-colors rounded-md shadow-xs min-h-[44px] whitespace-nowrap"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-5 py-3 text-sm sm:text-base font-semibold text-[#292524] bg-[#EFECE6] hover:bg-[#E2DDD3] active:bg-[#D5CFBF] transition-colors rounded-md border border-[#DCD6C9] min-h-[44px] whitespace-nowrap"
              >
          ...
          <div className="lg:col-span-5 relative mt-1 lg:mt-0">
            <div className="relative rounded-lg overflow-hidden border border-[#E2DDD3] bg-white shadow-xs">
              <div className="relative aspect-4/3 sm:aspect-16/10 lg:aspect-4/3 w-full bg-[#F5F2EB]">
                <Image
